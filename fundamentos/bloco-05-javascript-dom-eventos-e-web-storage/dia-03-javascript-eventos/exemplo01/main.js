...
function adiconarClasseTech (event) {
...
firstLi.addEventListener('click', adiconarClasseTech);
secondLi.addEventListener('click', adiconarClasseTech);
thirdLi.addEventListener('click', adiconarClasseTech)
