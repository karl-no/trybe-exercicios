...
def merge(numbers, start, mid, end):
    ...
    for general_index in range(start, end):  # percorrer sobre a lista inteira
        ...
        elif left[left_index] < right[right_index]:  # se o elemento do topo
            #  da esquerda for menor que o da direita, ele será o escolhido
            numbers[general_index] = left[left_index]
            left_index = left_index + 1
        else:
            numbers[general_index] = right[right_index]  # caso o da direita
            # seja menor, ele será o escolhido
            right_index = right_index + 1
